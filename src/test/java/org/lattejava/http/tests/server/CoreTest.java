  ...
  public void tlsIssues() throws Exception {
    ...
    try (var client = makeClient("https", null); var ignore = makeServer("https", handler).start()) {
      ...
      HttpRequest request = HttpRequest.newBuilder()
                                       ...
                                       .header("Cookie", "_pk_id.1.8f36=19a58ac7d2eae34e.1703797254.; _pk_ses.1.8f36=1; lattejava.locale=en; lattejava.timezone=America/Denver; lattejava.trusted-device.LJ9DfxybqbRJDIEar0MjOs1Dh9t4CUII7Ynx6BwZTbM=vAZ_0ETfK-utHZr6ErKdZm3s13LnYSmo8v417oiOB2wYmD09Nb_EYTcZ0RZFfkFf; lattejava.known-device.LJ9DfxybqbRJDIEar0MjOs1Dh9t4CUII7Ynx6BwZTbM=oR3hEmqnAZQNtsYHG-3iSfkTVaohg0AQx_4WTfIS_213Lz6hxqPrBoj5LePRFqQd; federated.csrf=_I0Ug4kFjA7XhWva; lattejava.sso=AoG7EJ2m0K5rARXr8LtYE_mjHpZSI2gMuHSzl-LD3e9SyBTTQszseRICR14rbUiqz7cwDfI3FgNcWbJBjvge506EHUfwBw-zGaM6pkDVoXfDIrOJdNUuCa8Ypzlt9lA6EqlTXZVWucErgXU1GxzikDA; lattejava.remember-device=QkJCARHvawOLQQo6u55SnnjQnB9azwdr-fk7WmSc7NEEokml; lattejava.rt=532xIZvgP15j7_s6XwKSh33Fj10waD8GeRqE7nEQe4D4CZl2VSitmQ; lattejava.at=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCIsImd0eSI6WyJhdXRob3JpemF0aW9uX2NvZGUiXSwia2lkIjoiY2QwYWIwYmUzIn0..twCgoWKPVLJuBaTCGTMdKWto8XICHpCk6zp2QkSIjNM; org.lattejava.app.action.admin.tenant.IndexAction$s=QkJCA9x7yVuN7noZSN59WZMzJZGPcjSGAJjVr5ghJbPz3sOOcoCAS7PrcyMXBax0Cb6JdqCebWfX0tD4Y3lt5EK9KM8=")
                                       .header("Origin", "https://local.lattejava.org:9013")
                                       .header("Referer", "https://local.lattejava.org:9013/")
  ...
  public void unicode(String scheme) throws Exception {
    ...
    try (var client = makeClient(scheme, null); var ignore = makeServer(scheme, handler).start()) {
      ...
      if (scheme.equals("https")) {
        uri = URI.create("https://local.lattejava.org:4242/위키백과:대문");
      }
      HttpRequest request = HttpRequest.newBuilder()
                                       .uri(uri)
                                       .GET()
