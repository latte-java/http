...
public class HPACKDecoder {
  // RFC 7541 Appendix A — 61 entries, indexed 1..61. Index 0 is invalid; using null sentinel for 1-based indexing.
  static final HPACKDynamicTable.HeaderField[] STATIC_TABLE = new HPACKDynamicTable.HeaderField[]{
      null, // 1-based; index 0 is invalid per RFC 7541 §2.1
