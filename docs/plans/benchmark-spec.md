...
|---|---|---|---|
| java-http | `benchmarks/self/` | LoadHandler (5 endpoints) | Done |
...
Reads the latest JSON from `benchmarks/results/`, generates a markdown performance table, and replaces the `## Performance` section in the project root `README.md`.
